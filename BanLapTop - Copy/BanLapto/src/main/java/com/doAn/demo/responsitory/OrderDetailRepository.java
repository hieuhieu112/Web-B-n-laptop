...
public interface OrderDetailRepository extends JpaRepository<OrderDetail, Integer>{
	...
	@Query(value = "SELECT o from OrderDetail o WHERE o.order.id = :idorder and o.product.id = :idpro")
	OrderDetail findByOrderProduct(@Param("idorder")Integer orderID,  @Param("idpro")Integer productid);
